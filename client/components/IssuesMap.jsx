...
import { IssuesByCategoryPieChart } from "./IssuesPieChart";
...
const IssuesMap = ({ issues, onIssueClick }) => {
  ...
  return (
    <div className="flex flex-col md:flex-row gap-5 mb-30">
      <Card className="w-full md:w-[70%] z-10">
        <CardHeader>
        ...
        <CardContent>
          <MapContainer
            ...
            className="w-full md:w-full h-[400px] rounded-md z-0"
          >
            <TileLayer
      ...
      <div className="w-full md:w-[35%] ">
        <IssuesByCategoryPieChart issuesData={issues} />
      </div>
    </div>
  );
};
